...
export default class Webview extends Abstract {
  ...
  render() {
    return (
      ...
      <WebView
           style={{flex: 1}}
           source={{uri: "http://localhost:3004/faecfedfe806008ad0fb352494210b39ed0b43ebd953744e613acf2375f1f609/me@bitar.io/editors/plus?type=editor&name=Plus%20Editor"}}
